		...
		\score {
			\new StaffGroup {
				\new Staff {
					...
					\compressFullBarRests \KyrieViolinoI
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Violino I"
					\compressFullBarRests \PaterViolinoI
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Violino I"
					\compressFullBarRests \SanctaMariaViolinoI
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Violino I"
					\compressFullBarRests \AgnusDeiIViolinoI
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Violino I"
					\compressFullBarRests \AgnusDeiIIViolinoI
				}
			}
		}
	}
