		...
		\score {
			\new StaffGroup {
				\new Staff {
					...
					\compressFullBarRests \KyrieViola
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Viola"
					\compressFullBarRests \PaterViola
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Viola"
					\compressFullBarRests \SanctaMariaViola
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Viola"
					\compressFullBarRests \AgnusDeiIViola
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Viola"
					\compressFullBarRests \AgnusDeiIIViola
				}
			}
		}
	}
