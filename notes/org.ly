...
KyrieBassFigures = \figuremode {
  ...
  <9+> <8> <5+ _+> r
  <5+ 4> <\t _+> \bo <[9] _!>4 \bc <[8]>8 <\t>
  <6 5>4 <9 _!>8 <8> <6 5!>4 <9>8 <8> %10
  <6! 5>4 <9 _!>8 <8> <6 5>4 <9>8 <8>
  <6 5>4 <9>8 <8> <4\+ 2>4 <6>
  r <6> <5 4> <\t 3>
  \bo <[9 \l]> <8> <6 4> <5 3>8 <4 2>
  \bc <[5 3]>1 %15
  r
  r
  <5 4>4 <\l [3]>8 <6 4> <7 3> <\t \t> r4
  <6>4 q r2
  <4 2>4 <\t \t> \bo <[3]>8 \bc <[4\+]> <6>4 %20
  <7> <6\\> r2
  <6>4 q <_+> r
  <5 4> <\t  _+>8 \bo <[6 4]> \bc <[7 _+]>4 <6>
  <5> <6\\>8 <5 _+>4 <\t \t>8 <6>4
  <7> <6\\> r2 %25
  r4. <5 _!>8 r4 <5>8 <6>
...
PaterBassFigures = \figuremode {
  ...
  r4 <[6]>8 <5>4 q8
  <_+>4. <6>
  <6>8 <_+> r r \bo <[5 2]> \bc <[\t \t]> %80
  <_+>4. <6>
  <_!> <[6]>
  r <5>
  q q
  q r %85
  <6 5> \bo <[9] 5>8 \bc <[8] 6> r
  <5>4. <6>4 <6 5>8
  r4. <5>4 <6>8
  <7>4. r8 <[6]> r
  r4. <_->4 <[6]>8 %90
  ...
  <6 [_+]> <_!>8 <\t> <6>
  <[5+] _+>4 <6 [_+]>8 <5 _!> <[6+] _+> <[5+] _+>
  <_!>4 \bo <[5+] _+>8 r \bc <[5+] _+> r
...
AgnusDeiIIBassFigures = \figuremode {
  ...
  <6 5 _+>4 <9 _!>8 <8> <6 5>4 <6 5 _+>
  <9+> <8> <5+ _+> r
  <5+ 4> <\t _+> \bo <[9] _!>4 \bc <[8]>8 <\t> %400
  <6 5>4 <9 _!>8 <8> <6 5!>4 <9>8 <8>
  <6! 5>4 <9 _!>8 <8> <6 5>4 <9>8 <8>
  <6 5>4 <9>8 <8> <4\+ 2>4 <6>
  r <6> <5 4> <\t 3>
  \bo <[9 \l]> <8> <6 4> <5 3>8 <4 2> %405
  \bc <[5 3]>1
  r
  r
  <5 4>4 <\l [3]>8 <6 4> <7 3> <\t \t> r4
  <6>4 q r2 %410
  <4 2>4 <\t \t> \bo <[3]>8 \bc <[4\+]> <6>4
  <7> <6\\> r2
  <6>4 q <_+> r
  <5 4> <\t  _+>8 \bo <[6 4]> \bc <[7 _+]>4 <6>
